...
export const NewSubcategoryButton = ({ title, id, active, additionClass, subcategories, showButtonId, onMouseEnter, onMouseMove, onMouseLeave, onMouseEnterCat, onMouseLeaveCat }) => {
